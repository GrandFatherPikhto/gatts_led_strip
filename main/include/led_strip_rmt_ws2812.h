...
/**
* @brief Тип Светодиодной ленты
*
*/
typedef struct led_strip_s led_strip_t;

/**
* @brief Тип устройства Светодиодной ленты
*
*/
typedef void *led_strip_dev_t;

/**
* @brief функция которая описывает тип светодиодной ленты
*
*/
struct led_strip_s {
    /**
    * @brief Устанавливает RGB определённого пиксела ленты
    *
    * @param strip: Указатель на объект "светодиодная лента"
    * @param index: индекс устанавливаемого пикселя
    * @param red: красная составляющая цвета
    * @param green: зелёная составляющая цвета
    * @param blue: голубая составляющая цвета
    *
    * @return
